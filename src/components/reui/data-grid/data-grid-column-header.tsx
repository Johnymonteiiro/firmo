...
function DataGridColumnHeaderInner<TData, TValue>({
  ...
  const headerLabelClassName = cn(
    "text-muted-foreground inline-flex h-full items-center gap-1.5 font-medium tracking-[0.04em] [&_svg]:opacity-60 text-xs [&_svg]:size-3.5",
    className
  )

  const headerButtonClassName = cn(
    "text-muted-foreground hover:bg-secondary data-[state=open]:bg-secondary hover:text-foreground data-[state=open]:text-foreground -ms-2 px-2 font-medium tracking-[0.04em] text-xs h-6 rounded-lg",
    className
  )
