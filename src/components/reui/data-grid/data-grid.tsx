...
function DataGridProvider<TData extends object>({
  ...
  // Memoize context value. Column sizing/sizing-info ARE included so that
  // live resizing (columnResizeMode "onChange") re-renders the header/table and
  // recomputes the column-size CSS variables. Body rows are memoized separately
  // (MemoizedDataGridTableBodyRows), so drag performance stays fine.
  const value = useMemo(
    () => ({
      props,
      table,
